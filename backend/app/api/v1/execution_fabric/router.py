...
async def get_topology_summary(
    ...
    try:
        from ...domains.event_topology.services import EventTopologyService
...
async def list_event_contracts(
    ...
    try:
        from ...domains.event_topology.models import ContractStatus
        from ...domains.event_topology.services import EventTopologyService
...
async def get_runtime_summary(
    ...
    try:
        from ...domains.distributed_runtime.services import DistributedRuntimeService
...
async def get_cognition_summary(
    ...
    try:
        from ...domains.cognition_fabric.services import CognitionFabricService
...
async def get_health_summary(
    ...
    try:
        from ...domains.self_healing.services import SelfHealingOrchestrationService
...
async def get_execution_summary(
    ...
    try:
        from ...domains.semantic_execution.services import SemanticExecutionService
...
async def get_observability_summary(
    ...
    try:
        from ...domains.predictive_observability.services import PredictiveObservabilityService
