...
class AnomalyDetection(BaseModel):
    """Anomaly detection - tracks detected anomalies"""
    ...
    # Severity
    severity: Mapped[str] = mapped_column(String(20), default=AnomalySeverity.WARNING.value, index=True)
    ...
    detection_signals: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSON, nullable=True)
...
class HealthCheck(BaseModel):
    ...
    check_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSON, nullable=True)
