...
class ExecutionTuningHistory(BaseModel):
    ...
    __table_args__ = (
        ...
        Index("ix_tune_history_started_at", "started_at"),
    )
...
# DEPRECATED: orchestration_stability_metrics has moved. Import from authoritative location.
class OrchestrationStabilityMetrics:
    ...
    def __init__(self, *args, **kwargs):
        raise RuntimeError(
            f"OrchestrationStabilityMetrics is no longer in {filepath}. "
