...
class SocialPost(BaseModel):
    ...
    account_id = Column(PGUUID(as_uuid=True), ForeignKey("social_accounts.id"), nullable=True)
    account = relationship("SocialAccount", back_populates="posts")
    
    campaign_id = Column(PGUUID(as_uuid=True), ForeignKey("campaigns.id"), nullable=True)
    campaign = relationship("Campaign", back_populates="social_posts")
    
    track_id = Column(PGUUID(as_uuid=True), ForeignKey("tracks.id"), nullable=True)
