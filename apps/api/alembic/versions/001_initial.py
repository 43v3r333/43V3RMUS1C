...
This migration creates all core tables for 43V3R CORE:
- Users and authentication
- Media content (artists, albums, tracks, projects)
- Assets (media files and generated content)
...
def upgrade() -> None:
    ...
    op.create_index('ix_artists_deleted_at', 'artists', ['deleted_at'])
    ...
    op.create_table(
        ...
        sa.Column('is_single', sa.Boolean(), nullable=False, default=False),
    ...
    op.create_index('ix_tracks_deleted_at', 'tracks', ['deleted_at'])
    ...
    op.create_index('ix_generated_assets_deleted_at', 'generated_assets', ['deleted_at'])
    ...
    op.create_index('ix_render_jobs_deleted_at', 'render_jobs', ['deleted_at'])
    ...
    op.create_index('ix_automation_jobs_name', 'automation_jobs', ['name'])
    op.create_index('ix_automation_jobs_status', 'automation_jobs', ['status'])
    op.create_index('ix_automation_jobs_deleted_at', 'automation_jobs', ['deleted_at'])
    ...
    op.create_index('ix_ai_prompts_deleted_at', 'ai_prompts', ['deleted_at'])
    ...
    op.create_index('ix_platform_metrics_metric_type', 'platform_metrics', ['metric_type'])
    ...
    op.create_index('ix_brand_profiles_deleted_at', 'brand_profiles', ['deleted_at'])
