...
"""
from sqlalchemy import JSON, Column, String, Integer, Float, Boolean, Text, ForeignKey, DateTime, JSON, Enum
...
class MediaAsset(BaseModel):
    ...
    # Technical metadata
    meta_info = Column("metadata", JSON, nullable=True)  # Full ffprobe output
